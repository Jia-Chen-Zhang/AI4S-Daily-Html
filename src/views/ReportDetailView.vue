...
<template>
  <div>
    ...
    <div v-else-if="error" class="py-20 text-center">
      ...
      <router-link to="/archive" class="mt-4 inline-block text-sm text-accent hover:underline">
        ← 返回归档列表
      </router-link>
    </div>
